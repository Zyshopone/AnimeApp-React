...
// Yang Dijadikan Semacam data API nya tetapi masih statis tidak Dinamis dari Link URL
const animesData = [
  {
    mal_id: 21,
    title: 'One Piece',
...
export default function App() {
  ...
  return (
    <>
    {/* Ada Dua Komponen Besar YAng Nantinya akan dipecah Kembali menjadi komponen kecil Navbar & Main*/}
      <NavBar>
        <Search>
...
// Komponen Pecahan dari function App()
function NavBar({children}){
  return(
    <nav className="nav-bar">

      {/* memecah menjadi komponen kecil */}
       <Logo/>
       {/* memecah menjadi komponen kecil(Search) */}
        {children}
...
// pecahan dari Komponen function NavBar()
function Logo(){
  return (
     <div className="logo">
          <span role="img">🍥</span>
...
function Search({children}){
  ...
  return(
    <div className="search-container">
          ...
          {/* dibuat komponen kecil lagi(NumResult) */}
          {children}
    </div>
  )
}

// pecahan dari Komponen function Search()
...
function Main({children}){
  ...
  return(
    <main className="main">
      {/* memecah menjadi komponen kecil (Box) */}
      {children}
...
// pecahan dari komponen function Main()
  ...
  return(
     <div className="box">
          <button className="btn-toggle" onClick={() => setIsOpen((open) => !open)}>
           ...
           {/* memecah menjadi komponen kecil (AnimeList) */}
          {isOpen &&  children }
...
// pecahan dari komponen function ListBox()
function AnimeList({animes, onSelectedAnime}){
  return(
    <ul className="list list-anime">
              {animes?.map((anime) => (
                // memeacah menjadi komponen kecil
...
// pecahan dari komponen function AnimeList()
...
// pecahan dari komponen function SelectedBox()
